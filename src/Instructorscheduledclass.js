import './Instructorscheduledclass.css';
    ...
    render() {
        return(
            <li>
                <div className="isc">
                    <div className="dth">
                        <p className="day">{this.state._ds}</p>
                        <p className="time">{this.state._ts}</p>
                    </div>
                    <div className="icf">
                        <p className="cap">{`${this.props.ses.students.length}/${this.props.ses.capacity} students enrolled`}</p>
                        <button onClick={this.cancelHandle} className="instcb">Cancel</button>
                    </div>
                </div>
            </li>
        )
